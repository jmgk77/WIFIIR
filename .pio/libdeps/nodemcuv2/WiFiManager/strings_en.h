...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Saving Credentials<br/>Trying to connect ESP to network.<br />If it fails reconnect to AP to try again</div><script>setTimeout(function (){document.location.href = 'http://wifiir.local';}, 30000);</script>";
